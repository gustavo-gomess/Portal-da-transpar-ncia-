        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="border-l-4 border-l-primary">
            ...
            <CardContent className="space-y-4">
              <div className="text-3xl font-bold text-primary">R$ 7.500,00</div>
              ...
              <div className="space-y-3 pt-4 border-t">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">R$ 7.500,00</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-destructive">
            ...
            <CardContent className="space-y-4">
              <div className="text-3xl font-bold text-destructive">R$ 2.550,00</div>
              ...
              <div className="space-y-3 pt-4 border-t">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">R$ 2.100,00</span>
                  </div>
                  <p className="text-xs text-muted-foreground ml-4">R$ 14,00 × 150 clientes</p>
                </div>
                ...
                <p className="text-xs text-muted-foreground ml-4">Ex: Gasolina, troca de controle</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-3 text-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-destructive">- R$ 2.550,00</p>
              </div>
              ...
              <div className="sm:col-span-1">
                <div className="border-t-2 border-dashed border-muted-foreground/30 pt-2">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <p className="text-3xl font-bold text-accent">R$ 4.950,00</p>
                  </div>
                </div>
              </div>
            </div>
